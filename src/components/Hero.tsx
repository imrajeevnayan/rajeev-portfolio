      ...
      <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center">
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 bg-blue-200 dark:bg-blue-800 rounded-full blur-3xl opacity-20 animate-pulse"></div>
            <img
              src="https://i.ibb.co/Y4stRcGk/1752515067277.jpg?fit=crop&w=800&q=80"
              alt="Rajeev Nayan"
              className="rounded-full w-48 h-48 md:w-64 md:h-64 object-cover mx-auto shadow-2xl ring-4 ring-white dark:ring-gray-800 transform hover:scale-105 transition-transform duration-300"
            />
          </div>
        </motion.div>
      </div>
